...
public class BoundedIntegerFilter extends DocumentFilter {

    private final int minValue;
    private final int maxValue;

    public BoundedIntegerFilter(int minValue, int maxValue) {
    ...
    private boolean test(String text) {
        try {
            ...
            return (Integer.parseInt(text) >= minValue && Integer.parseInt(text) <= maxValue);
