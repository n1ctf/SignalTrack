...
public class TimeUDP extends SwingWorker<Date, Void> implements AutoCloseable {
    ...
    private static final Logger LOG = Logger.getLogger(TimeUDP.class.getName());
    ...
    private void configureLogger() {
		...
		Handler ch = null;
		try {
			fh = new FileHandler("%t/TimeUDP.log");
