...
public class TileSourceInfo {
    ...
    protected Map<String, String> noTileHeaders = new HashMap<>();
    ...
    protected Map<String, String> metadataHeaders = new HashMap<>();
    ...
    /**
     * Request header information for empty tiles for servers delivering such tile components
