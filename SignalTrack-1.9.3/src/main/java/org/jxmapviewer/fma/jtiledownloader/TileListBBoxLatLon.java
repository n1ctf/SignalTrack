...
public class TileListBBoxLatLon extends TileListCommonBBox {
	...
	public void calculateTileValuesXY() {
		log.log(Level.FINE, "Calculate Tile Values for (BBoxLatLon):");

		log.log(Level.FINE, "  minLat = {0}", _minLat);
		log.log(Level.FINE, "  minLon = {0}", _minLon);
		log.log(Level.FINE, "  mxaLat = {0}", _maxLat);
		log.log(Level.FINE, "  maxLon = {0}", _maxLon);
