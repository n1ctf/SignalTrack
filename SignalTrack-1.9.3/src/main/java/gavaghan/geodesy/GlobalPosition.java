...
public class GlobalPosition extends GlobalCoordinates {
	 ...
	 * longitudes. If longitudes are equal, then southern latitudes are less than
	 * northern latitudes. If coordinates are equal, lower elevations are less than
	 * higher elevations
	 * 
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof GlobalPosition other)) {
			return false;
		}
