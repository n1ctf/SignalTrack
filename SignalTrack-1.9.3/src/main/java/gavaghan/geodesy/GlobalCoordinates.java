...
public class GlobalCoordinates implements Comparable<GlobalCoordinates> {
	...
	/**
	 * Set latitude. The latitude value will be canonicalized (which might result in
	 * a change to the longitude). Negative latitude is southern hemisphere.
	 * 
	...
	/**
	 * Set longitude. The longitude value will be canonicalized. Negative longitude
	...
	/**
	 * Compare these coordinates to another set of coordinates. Western longitudes
	 * are less than eastern longitudes. If longitudes are equal, then southern
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof GlobalCoordinates other)) {
			return false;
		}
		return Math.abs(mLongitude - other.mLongitude) < 0.0000001 && Math.abs(mLatitude - other.mLatitude) < 0.0000001;
	}
