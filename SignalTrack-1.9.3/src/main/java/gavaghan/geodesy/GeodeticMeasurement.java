...
public class GeodeticMeasurement extends GeodeticCurve {
	 ...
	 */
	public GeodeticMeasurement(double ellipsoidalDistance, double azimuth, double reverseAzimuth,
	...
	public int hashCode() {
		...
		result = prime * result + Objects.hash(mElevationChange, mP2P);
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		final GeodeticMeasurement other = (GeodeticMeasurement) obj;
		return Double.doubleToLongBits(mElevationChange) == Double.doubleToLongBits(other.mElevationChange)
				&& Double.doubleToLongBits(mP2P) == Double.doubleToLongBits(other.mP2P);
	}
}
