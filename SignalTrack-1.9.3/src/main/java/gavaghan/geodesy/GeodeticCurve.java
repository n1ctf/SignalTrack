...
public class GeodeticCurve {
	...
	@Override
	public int hashCode() {
		return Objects.hash(mAzimuth, mEllipsoidalDistance, mReverseAzimuth);
	}
	...
	public boolean equals(Object obj) {
		...
		final GeodeticCurve other = (GeodeticCurve) obj;
		return Double.doubleToLongBits(mAzimuth) == Double.doubleToLongBits(other.mAzimuth)
				&& Double.doubleToLongBits(mEllipsoidalDistance) == Double.doubleToLongBits(other.mEllipsoidalDistance)
				&& Double.doubleToLongBits(mReverseAzimuth) == Double.doubleToLongBits(other.mReverseAzimuth);
	}
