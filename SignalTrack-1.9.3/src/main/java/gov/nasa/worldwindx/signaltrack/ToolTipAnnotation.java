...
/**
 * Displays a tool tip annotation at a specified screen position. Typically used
 * in conjunction with
 * {@link gov.nasa.worldwindx.examples.util.ToolTipController}.
 *
 * @author tag
...
public class ToolTipAnnotation extends ScreenAnnotation {
	...
	/**
	 * Indicates the screen-coordinate offset of the tool tip from the tool tip
	 * position.
	 *
	...
	/**
	 * Specifies the screen-coordinate offset of the tool tip from the tool tip
	 * position.
	 *
	 * @param tooltipOffset the tool tip offset. The default is five pixels to the
	 *                      left and up.
	 */
