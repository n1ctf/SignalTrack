...
/**
 * Controls highlighting of shapes implementing {@link Highlightable} in
 * response to pick events. Monitors a specified World Window for an indicated
 * {@link gov.nasa.worldwind.event.SelectEvent} type and turns highlighting on
 * and off in response.
 *
 * @author tag
...
public class HighlightController implements SelectListener {
	...
	protected void highlight(Object o) {
		...
		if (o instanceof Highlightable highlightable) {
			this.lastHighlightObject = highlightable;
