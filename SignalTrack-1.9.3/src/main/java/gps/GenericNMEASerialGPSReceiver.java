...
public class GenericNMEASerialGPSReceiver extends AbstractGpsProcessor {

    private static final long serialVersionUID = 2429324720987509141L;

    private static final String MODEL_NAME = "Serial NMEA GPS Receiver";
    ...
    private static final Logger LOG = Logger.getLogger(GenericNMEASerialGPSReceiver.class.getName());
    ...
    public GenericNMEASerialGPSReceiver(Boolean clearAllPreferences) {
