...
public class OStarzBTQ920Receiver extends AbstractGpsProcessor {

    private static final long serialVersionUID = 2429326110040367329L;

    private static final String MODEL_NAME = "BT-Q920 Bluetooth GPS Receiver";
    private static final String MANUFACTURER = "OStarz";
    ...
    private static final Logger LOG = Logger.getLogger(OStarzBTQ920Receiver.class.getName());
    ...
    public OStarzBTQ920Receiver(Boolean clearAllPreferences) {
